 ...
 * {@link RequestConfigDelegate#setBody(Object) body} is set from the builder,
 * it is
 ...
 * the equivalent <code>a=1&b=two</code> in the request body.
 * </p>
 *
 * <p>
 ...
 * <code>content-encoding</code> HTTP header.
 * </p>
 *
...
public class EncoderRegistry implements Iterable<Map.Entry<String, Closure>> {
    ...
    public HttpEntity encodeJSON(Object model, Object contentType) throws UnsupportedEncodingException {
        ...
        if (model instanceof Map) {
            ...
            json = JSONObject.fromObject(model); // Assume object is a JavaBean
     ...
     *         {@link HttpEntityEnclosingRequest#setEntity(HttpEntity) request
     *         content}
     * @throws UnsupportedEncodingException
     */
