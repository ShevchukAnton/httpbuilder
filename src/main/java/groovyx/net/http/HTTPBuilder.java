 ...
 * detail) from the {@link RequestConfigDelegate} as well. In any cases where
 * the value
 ...
 *
 * <p>
 * For instance, any methods that do not take a <code>uri</code> parameter
 ...
 * based on the response <code>content-type</code> header.
 * </p>
 *
 * <p>
 * <strong>If</strong> any contentType is given (either in
...
public class HTTPBuilder {
    ...
    protected final Map<Object, Closure> defaultResponseHandlers = new StringHashMap<Closure>(
     ...
     * @throws URISyntaxException if the given argument does not represent a valid
     *                            URI
     */
     ...
     *
     * @param defaultURI         either a {@link URL}, {@link URI} or object whose
     *                           <code>toString()</code> produces a valid URI
     *                           string. See
     *                           {@link URIBuilder#convertToURI(Object)}.
     ...
     *
     * <p>
     * <strong>Note:</strong> If using the
     ...
     *
     * @param args            see
     *                        {@link RequestConfigDelegate#setPropertiesFromMap(Map)}
     ...
     *
     * <p>
     * The request body (specified by a <code>body</code> named parameter)
     ...
     *
     * @param method        {@link Method HTTP method}
     * @param contentType   either a {@link ContentType} or valid content-type
     *                      string.
     * @param configClosure request configuration options
     * @return whatever value was returned by the executed response handler.
     * @throws ClientProtocolException
     ...
     *                      {@link RequestConfigDelegate#setBody(Object) request
     *                      body} and
     *                      {@link RequestConfigDelegate#getResponse() response
     *                      handlers}.
     * @return whatever value was returned by the executed response handler.
     * @throws ClientProtocolException
     * @throws IOException
     * @throws URISyntaxException      if the uri argument does not represent a
     *                                 valid URI
     */
     ...
     * config closure, then pass the delegate to
     * {@link #doRequest(RequestConfigDelegate)},
     ...
     * content-type, or <code>null</code> if no parser could be found for
     * this
     * content-type. The parser will also return <code>null</code> if the
     * response does not contain any content (e.g. in response to a HEAD
     * request).
    ...
    protected Object parseResponse(HttpResponse resp, Object contentType)
        ...
        if (parser == null)
            log.warn("No parser found for content-type: "
                    + responseContentType);
        else {
     ...
     * <p>
     * For responses parsed as {@link ParserRegistry#parseStream(HttpResponse)
     ...
     * @param parsedData parsed data as resolved from this instance's
     *                   {@link ParserRegistry}
     ...
     * used by {@link RequestConfigDelegate} to retrieve the proper encoder for
     * building
     ...
     * <ol>
     * <li>It tells the builder to encode any
     ...
     *
     * @param ct either a {@link ContentType} or string value (i.e.
     *           <code>"text/xml"</code>.)
     * @see EncoderRegistry
     * @see ParserRegistry
     */
     ...
     *                               automatically insert an <code>Accept</code>
     *                               header, otherwise <code>false</code>.
     */
     ...
     *                  {@link ContentEncoding.Type} value, or a
    ...
    /**
     * Ignores certificate issues for SSL connections. Cert does not have to be from
     * a trusted authority
     * and the hostname does not need to be verified.
     * This is primarily for dev situations that make use of localhost, build, and
     * test servers.
     *
    ...
    public void ignoreSSLIssues()
        ...
        SSLSocketFactory sslSocketFactory = new SSLSocketFactory(trustStrat,
    ...
    protected class RequestConfigDelegate {
         ...
         *
         * <p>
         * This method signature returns <code>Object</code> so that the
         ...
         *
         * @return either a {@link ContentType} value or String like
         ...
         * <dl>
         * <dt>uri</dt>
         * <dd>Either a URI, URL, or object whose
         * <code>toString()</code> method produces a valid URI string.
         * If this parameter is not supplied, the HTTPBuilder's default
         * URI is used.</dd>
         * <dt>path</dt>
         * <dd>Request path that is merged with the URI</dd>
         * <dt>queryString</dt>
         * <dd>an escaped query string</dd>
         * <dt>query</dt>
         * <dd>Map of URL query parameters</dd>
         * <dt>headers</dt>
         * <dd>Map of HTTP headers</dd>
         * <dt>contentType</dt>
         * <dd>Request content type and Accept header.
         * If not supplied, the HTTPBuilder's default content-type is used.</dd>
         * <dt>requestContentType</dt>
         * <dd>content type for the request, if it
         * is different from the expected response content-type</dd>
         * <dt>body</dt>
         * <dd>Request body that will be encoded based on the given contentType</dd>
         * </dl>
         ...
         *
         * <p>
         * Example: <code>headers.'Accept-Language' = 'en, en-gb;q=0.8'</code>
         * </p>
         *
